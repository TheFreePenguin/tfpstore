install(){
  ...
  echo "echo \"Uninstalling TFPstore...\"; rm -r /usr/local/share/tfpstore; rm /usr/local/bin/tfpstore; rm /usr/local/bin/tfpstore-uninst" > /usr/local/bin/tfpstore-uninst
